...
<head>
	...
	<title>YBELC - Melhore sua posição na busca do google com SEO, campanhas no facebook, adwords, crie e gerencie o conteúdo do seu blog</title>
	...
	<link rel="shortcut icon" href="./img/logo_principal.png" type="image/x-icon">
</head>
<body>
	<div class="cabecalho">
		<h1 class="ds-none">YBELC - Melhore sua posição na busca do google com SEO, campanhas no facebook, adwords, crie e gerencie o conteúdo do seu blog</h1>
		<div class="main_menu">
			<div class="logo">
				<img src="./img/logo2.png" alt="[Logo Aqva]" title="Logo Aqva" />
			</div>
		...
		<h1><img src="./img/logo_principal_branco.png"/>belc</h1>
	...
	<section class="topo">
		<div class="center">
			<div class="topo-1">
				...
				<h1><strong>Somos</strong> <span>criativos</span> <strong> e focados em </strong><span>resultados</span></h1>
				<p>Uma equipe jovem e altamente qualificada garante o sucesso do seu projeto e produto. Especialistas em suas áreas, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
				<br />
	...
	<section class="section1">
		<div class="center">
			...
			<h3>Seu negócio precisa de um site.
Nós podemos criar</h3>
<p>Nossos programadores são visionários, além de criar seu site aplicando as melhores técnicas, trabalham o layout para proporcionar uma experiência visual incrível e de grande impacto. É técnica e bom gosto, tudo junto para o seu negócio decolar na internet!
Com a Agência Fox Creative o que é moderno, bonito e eficiente não precisa sempre ser de alto custo. Praticamos um dos melhores preços para criação de site do mercado.</p>
			</div>
	...
	<!-- SEO -->
	<section id="SEO" class="container text-center marginbottom3">
		<div class="row">
	...
	<nav>
		<h1 class="font0">YBELC - Agência Web</h1>
	<ul class="row">
		...
		<div class="copyright">
			<span>Todos os direitos reservados a YBELC - Agência WEB</span>
		</div>
	</nav>
